...
@InputType()
class ApplicationVersionCreateInput {
  @ApiProperty({
    required: false,
  ...
  @ApiProperty({
    required: false,
    type: () => PageVersionCreateNestedManyWithoutApplicationVersionsInput,
  })
  @ValidateNested()
  @Type(() => PageVersionCreateNestedManyWithoutApplicationVersionsInput)
  @IsOptional()
  @Field(() => PageVersionCreateNestedManyWithoutApplicationVersionsInput, {
    nullable: true,
  })
...
export { ApplicationVersionCreateInput as ApplicationVersionCreateInput };
