...
@InputType()
class ApplicationVersionCreateNestedManyWithoutApplicationsInput {
...
export { ApplicationVersionCreateNestedManyWithoutApplicationsInput as ApplicationVersionCreateNestedManyWithoutApplicationsInput };
