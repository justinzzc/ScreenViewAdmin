...
export class ApplicationResolverBase {
  ...
  @graphql.ResolveField(() => [ApplicationTag], { name: "applicationTags" })
  async findApplicationTags(
    ...
    const results = await this.service.findApplicationTags(parent.id, args);
  ...
  async findApplicationVersions(
    ...
    const results = await this.service.findApplicationVersions(parent.id, args);
